...
if(isset($_POST['delete'])){
    ...
    $sql="delete from package where id=$id_to_delete";
...
<body>
            ...
            <tbody>
                <?php foreach($records as $record):?>
                    ...
                    <tr>
                        ...
                        <td><a href=<?php echo "packagepayment.php?user_id=".$record['id'] ?> class="btn-small red waves-effect waves-light z-depth-3">PAY NOW</a></td>
                        <td><a href="#modal2" class="btn-small red waves-effect waves-light z-depth-3 modal-trigger">DETAILS</a></td>
                        <td><a href=<?php echo "packageupdate.php?user_id=".$record['id'] ?> class="btn-small red waves-effect waves-light z-depth-3">UPDATE BOOKING</a></td>
    ...
    <div id="modal1" class="modal">
        ...
        <div class="modal-footer">
            <form action="packagetable.php" method="POST">
    ...
    <div id="modal2" class="modal">
        ...
        <h4 class="brown-text center"><i><b>THE GRAND RESORT</b></i></h4><hr>
            ...
            <p class="container left-align"><strong>Id </strong>: <?php echo $record['id']; ?>
                ...
                <br><strong>Package Booked</strong>: <?php echo $rv[0]; ?>
