...
<head>
    ...
    <title>Event Booking Payment</title>
    <!-- font awesome -->
    ...
    <br>
        ...
        <div class="card-content center">
            ...
            <p class="container left-align"><strong>Id </strong>:<?php echo htmlspecialchars($user['id']);?>
                ...
                <br><strong>Arrival Date</strong>: <?php echo htmlspecialchars($user['date']); ?>
                <br><strong>Depature Date</strong>: <?php echo htmlspecialchars($user['time']); ?>
