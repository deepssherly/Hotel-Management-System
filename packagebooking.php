<?php
include('config.php');
$name=$email=$phone=$address=$checkin=$checkout=$pack='';
...
if(isset($_POST['submit'])){
    ...
    if(empty($_POST['checkin']) && empty($_POST['checkout']) && empty($_POST['pack']) && empty($_POST['address']) && empty($_POST['noofadults']) && empty($_POST['noofchildren'])){
        ...
        <div class="col container s10 m8 l6 offset-s1 offset-m2 offset-l3">
            <div class="card z-depth-5  #ffebee red lighten-5">
                <div class="card-content">
                    ...
                    <div class="row">
                        <form action="packagebooking.php" method="POST" class="col s10 m8 l6 offset-s1 offset-m2 offset-l3">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="input-field">
                                    <label for="dropdown" class="active brown-text"><strong>Choose your preferred package</strong></label>
