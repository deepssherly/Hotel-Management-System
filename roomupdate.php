...
if(isset($_POST['update'])){
    if(empty($_POST['name']) && empty($_POST['email'])  && empty($_POST['phone']) && empty($_POST['checkin']) && empty($_POST['checkout']) && empty($_POST['room']) && empty($_POST['address']) && empty($_POST['noofadults']) && empty($_POST['noofchildren'])){
    ...
    $id_to_update = mysqli_real_escape_string($conn, $_GET['user_id']);
    $query="update book set name='$name',email='$email',phone='$phone',address='$address',checkin='$checkin',checkout='$checkout',room='$room',noofadults='$noofadults',noofchildren='$noofchildren' where id='$id_to_update'";
        ...
        <div class="col container s10 m8 l6 offset-s1 offset-m2 offset-l3">
            <div class="card z-depth-5  #ffebee red lighten-5">
                <div class="card-content">
                    ...
                    <div class="row">
                    <form action= <?php echo "roomupdate.php?user_id=".$id_to_update;?> method="POST" class="col s10 m8 l6 offset-s1 offset-m2 offset-l3">
                            <div class="row">
